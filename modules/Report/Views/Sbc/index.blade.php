        ...
        <div class="mt-10">
            <div class="flex justify-between">
                ...
                <div class="w-1/3 text-center pr-6 mb-6">
                    <a href="{{ route('priority.index', ['stageId' => 2, 'did' => $districtprofile->id]) }}"
                ...
                <!-- Step 3 -->
                <div class="w-1/3 text-center pr-6 mb-6">
                    <a href="{{ route('dataentrystage.create', ['stageId' => 4, 'did' => $districtprofile->id]) }}"
                        class="flex items-center justify-center border border-gray-200 transition duration-300">
                        <div class="w-1/3 bg-[#844a8a] flex items-center justify-center h-16 rounded-l-lg">
                        ...
                        <div
                            ...
                            <p class="text-xs text-gray-600">Health and Nutrition Service Activities (IR2)</p>
                        </div>
                    </a>
                </div>
                <!-- Step 3 End -->
          ...
          <div class="flex items-center justify-between mb-4">
            <h2 class="text-lg font-bold">Step 3. Social Behavior Change (SBC) Activities (IR1) </h2>
            <form action="{{ route('stages.resetStatus') }}" method="Post">
                @csrf
                <input type="number" name="district_id" value="{{ $districtprofile->id }}" hidden>
                <input type="number" name="stage_id" value="3" hidden>
                <button type="submit"
