        ...
        <div class="bg-white p-4 rounded-lg w-full mb-5">
            ...
            <div class="flex flex-wrap -mx-2">
                <div class="w-1/3 px-2 mb-6">
                    <label for="" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"># of Municipality</label>
                    <input type="text" id="question" name="question" value=""
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="" required="" fdprocessedid="c6wgz8">
                </div>  
                <div class="w-1/3 px-2 mb-6">
                    <label for="" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"># of Vulnerable Municipality</label>
                    <input type="text" id="question" name="question" value=""
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="" required="" fdprocessedid="c6wgz8">
                </div> 
            ...
            <form action="{{ route('priority.store') }}" method="POST">
                ...
                <table class="min-w-full border-collapse bg-white border-gray-200 rounded-lg overflow-hidden">
                    <thead class="rounded-lg">
                        <tr>
                            <th rowspan="2" class="bg-gray-500 text-white text-xs p-2">Municipality</th>
                            ...
                            <th rowspan="2" class="bg-gray-500 text-white text-xs p-2">Questions (based on MSNP
                                III
                                indicators)</th>
                                ...
                                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                    ...
                                    <div class="mt-2">
                                        <p class="text-sm leading-5 text-gray-500">
                                            Are you sure you want to delete this prioritize behaviors?This action cannot
                                            be
                                            undone.
                                        </p>
                                    </div>
                ...
                <div class="relative w-full max-w-2xl p-6 mx-auto bg-white rounded-lg shadow-lg">
                    ...
                    <form id="edit-form" method="POST">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="mb-4">
                                <label for="response-underserved"
                                    class="block text-sm font-medium text-gray-700">Response
                                    Underserved</label>
