            ...
            <table class="min-w-full border-collapse bg-white border-gray-200 rounded-lg overflow-hidden">
                <thead class="rounded-lg">
                    <tr>
                        ...
                        <th rowspan="2" class="bg-gray-500 text-white text-xs p-2">Questions (based on MSNP III indicators)</th>
                    ...
                    <tr>
                        <th class="bg-gray-500 text-white text-xs p-2 w-16">All</th>
                        <th class="bg-gray-500 text-white text-xs p-2 w-16">Underserved</th>
                    </tr>
                </thead>
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                            <div class="flex space-x-4">
                                ...
                                <button type="button" class="text-red-500 hover:text-red-700" onclick="')">
