                        ...
                        <tr>
                            ...
                            <td class="border text-sm border-gray-200 p-2">
                                @if ($priority->priority != 0)
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24"
                                        height="24" fill="green" class="m-auto">
                                ...
                                @else
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24"
                                        height="24" fill="red" class="m-auto">
                                        <circle cx="12" cy="12" r="10" fill="none" stroke="red"
                                            stroke-width="2" />
                                        <path d="M6 6l12 12M18 6L6 18" stroke="red" stroke-width="2"
                                            fill="none" />
                                    </svg>
                                @endif
                            </td>
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                <div class="flex space-x-4">
                                    <a href="#"
                                        onclick="showEditModal('{{ route('priority.update', $priority->id) }}', {{ $priority->priority }})"
