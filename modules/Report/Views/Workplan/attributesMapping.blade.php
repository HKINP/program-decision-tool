            ...
            <table id="myTable" class="min-w-full border-collapse border divide-y divide-gray-200 mt-8 border-gray-300">
                ...
                <thead>
                    <tr class="bg-purple-800 text-white">
                        ...
                        <th class="text-xs border border-gray-300 p-2 text-center">Attributes</th>
                    </tr>
                </thead>
                <!-- Body Section -->
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="text-black">
                        ...
                        <td>
                            @php
                            $selectedIds = explode(',', $programactivity->attributes);
                            @endphp
                            <select class="activities_attributes" name="attributes[]" data-activity-id="{{ $programactivity->id }}" multiple>
                                @foreach ($attributes as $key => $value)
                                <option value="{{ $key }}" {{ in_array($key, $selectedIds) ? 'selected' : '' }}>
                                    {{ $value['name'] }}
                                </option>
                                @endforeach
                            </select>
                    ...
                    <tr class="text-black">
                        ...
                        <td class="border border-gray-300 p-2 text-xs">
                            <select class="activities_attributes" data-activity-id="{{$activity['id'] }}" name="attributes[]" multiple>
                                @foreach ($attributes as $key=>$value)
                                <option value="{{ $key }}">
                                    {{ $value['name'] }}
                                </option>
                    ...
                    <tr class="text-black">
                        ...
                        <td class="border border-gray-300 p-2 text-xs">
                            <select class="activities_attributes" data-activity-id="{{ $programactivity->id }}" name="attributes[]" multiple>
                                @foreach ($attributes as $key=>$value)
                                <option value="{{ $key }}">
                                    {{ $value['name'] }}
                                </option>
