    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        <div class="-my-2 py-2 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Add District Profile</h1>
            </div>
        ...
        <div class="-my-2 py-2 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8 ">
            <div
                ...
                <x-form-component :action="route('districtprofile.store')" :method="'POST'" :fields="[
                    [
                        'name' => 'district_id',
                        'label' => 'District Name',
                        'type' => 'select',
