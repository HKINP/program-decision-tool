<x-app-layout>
    @if ($activityTypeid != 3 && $activityTypeid != 0)
        <x-table-listing :title="@isset($activityType)
    ...
    isset($activityType) ? [] : ['Activity Type'], 
    isset($ir) ? ['IR', 'Outcomes'] : [],
    ['Activities Name', 'Responsible Partners', 'Unit', 'Budget','Order', 'Actions']
)"
    :useAddModal="false"
    :name="'province'"
    :addRoute="route('activities.create', ['activity_id' => $activityTypeid ?? ''])">
    ...
    <tr>
        ...
        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
            ...
            <input type="text" id="activity_id" name="activity_id" value="{{ $activities->id }}" hidden />
