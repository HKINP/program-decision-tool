...
Route::middleware(['auth:sanctum', 'verified'])->group(function () {
    ...
    Route::get('dataentry', [DashboardController::class, 'dataentry'])->name('dataentry.create');

    // Route::get('/dataentry/{district}', [DashboardController::class, 'dataentryCreate'])->name('dataentry.create');
