        ...
        <div class="relative flex">
            ...
            <div class="h-full md:w-1/2">
                ...
                <div class="min-h-[100dvh] h-full flex flex-col justify-between">
                    ...
                    <div>
                        <div class="flex items-center justify-evenly h-16 px-4 py-12 sm:px-6 lg:px-8 bg-white">
                            <img class="object-cover object-center h-12" src="{{ asset('images/FHI360.jpg') }}" alt="FHI360 Logo" />
                            <img class="object-cover object-center h-12" src="{{ asset('images/CEAPRED.jpg') }}" alt="CEAPRED Logo" />
                            <img class="object-cover object-center h-12" src="{{ asset('images/ENPHO.jpg') }}" alt="ENPHO Logo" />
                            <img class="object-cover object-center h-12" src="{{ asset('images/NTAG.jpg') }}" alt="NTAG Logo" />
                            <img class="object-cover object-center h-6" src="{{ asset('images/Kaboom.jpg') }}" alt="Kaboom Logo" />
                        </div>
                    </div>
