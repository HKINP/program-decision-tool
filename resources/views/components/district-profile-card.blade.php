    ...
    <table class="min-w-full border-collapse bg-white border-gray-600 rounded-lg overflow-hidden">
        <thead class="rounded-lg">
            <tr>
                ...
                <th class="bg-gray-500 text-white text-xs p-2 whitespace-normal align-top" style="line-height: 1.2;">Geography (municipalities)</th>
            ...
            @foreach ($districtVulnerability as $data)
                <tr>
                    ...
                    <td class="p-2 text-center">
                        {{$data->remote_status + $data->caste_ethnicity_status + $data->geography_status + $data->food_security_status + $data->wealth_status}}
                    </td>
                    <td class="p-2 text-center">
