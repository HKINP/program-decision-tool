        ...
        <div class="overflow-x-auto mt-6">
            <table class="min-w-full border-collapse border bg-white border-gray-200">
              <thead>
                ...
                <tbody>
                  <tr>
                    <td class="border text-sm border-gray-200 p-2" rowspan="7">Children</td>
                    <td class="border text-sm border-gray-200 p-2" rowspan="3">Breastfeeding</td>
                    <td class="border text-sm border-gray-200 p-2">1</td>
                    <td class="border text-sm border-gray-200 p-2">What proportion of children are breastfed within the first hour of birth?</td>
                    <td class="border text-sm border-gray-200 p-2">1</td>
                    <td class="border text-sm border-gray-200 p-2">1</td>
                    <td class="border text-sm border-gray-200 p-2">1</td>
                  </tr>
                  <tr>
                    ...
                    <td class="border border-gray-200 p-2">What proportion of children are breastfed exclusively for 6 months after birth?</td>
                    <td class="border text-sm border-gray-200 p-2">1</td>
                    <td class="border text-sm border-gray-200 p-2">1</td>
                    <td class="border text-sm border-gray-200 p-2">1</td>
                  </tr>
                  <tr>
                    ...
                    <td class="border border-gray-200 p-2">What proportion of children are breastfed until at least 24 months of age?</td>
                    <td class="border text-sm border-gray-200 p-2">1</td>
                    <td class="border text-sm border-gray-200 p-2">1</td>
                    <td class="border text-sm border-gray-200 p-2">1</td>
                  </tr>
                  <tr>
                    <td class="border border-gray-200 p-2" rowspan="4">Complementary feeding</td>
                    <td class="border border-gray-200 p-2">4</td>
                    <td class="border border-gray-200 p-2">What proportion of children were introduced complementary foods during 6-8 months?</td>
                    <td class="border border-gray-200 p-2">
                      <div class="flex justify-between items-center">
                        <div class="bg-green-500 w-1/2 text-center text-white">84</div>
                        <div class="bg-green-500 w-1/2 text-center text-white">80</div>
                      </div>
                    </td>
                  ...
                  <tr>
                    ...
                    <td class="border border-gray-200 p-2">What proportion of children 6-23 months are fed the age-appropriate frequency of foods?</td>
                    <td class="border border-gray-200 p-2">
                      <div class="flex justify-between items-center">
                        <div class="bg-green-500 w-1/2 text-center text-white">84</div>
                        <div class="bg-green-500 w-1/2 text-center text-white">90</div>
                      </div>
                    </td>
                    <td class="border border-gray-200 p-2"></td>
                  </tr>
                  <tr>
                    ...
                    <td class="border border-gray-200 p-2">What proportion of children 6-23 months have minimum dietary diversity (4+ food groups)?</td>
                    <td class="border border-gray-200 p-2">
                      <div class="flex justify-between items-center">
                        <div class="bg-yellow-500 w-1/2 text-center text-white">52</div>
                        <div class="bg-yellow-500 w-1/2 text-center text-white">51</div>
                      </div>
                    </td>
                    <td class="border border-gray-200 p-2"></td>
                  </tr>
                  <tr>
                    ...
                    <td class="border border-gray-200 p-2">What proportion of children 6-23 months consume sweet beverages?</td>
                    <td class="border border-gray-200 p-2">
                      <div class="flex justify-between items-center">
                        <div class="bg-red-700 w-1/2 text-center text-white">41</div>
                        <div class="bg-red-700 w-1/2 text-center text-white">39</div>
                      </div>
                    </td>
                    <td class="border border-gray-200 p-2"></td>
                  </tr>
